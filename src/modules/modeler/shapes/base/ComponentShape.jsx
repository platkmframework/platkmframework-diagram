...
//---------------------FUNCIONES DE MOVIMIENTO IMPLEMENTADAS POR TODAS LAS FIGURAS----------------- */
    ...
    //---------------------
      drawUMLComponent(ctx, x, y, width, height, componentName) {
        ...
        // Draw "lollipop" notation for interfaces on the side
        const lollipopRadius = 6;
        const interfaceX = x - 20; // Left side of the component
        const interfaceY = y + headerHeight + 20; // Slightly below the header
  
        // Draw circle (lollipop head)
        ctx.beginPath();
        ctx.arc(interfaceX, interfaceY, lollipopRadius, 0, 2 * Math.PI);
        ctx.fillStyle = "#000";
        ctx.fill();
        ...
        ctx.font = "12px Arial";
        ctx.textAlign = "right";
        ctx.fillText("Interface", interfaceX - 5, interfaceY + 4);
      }
