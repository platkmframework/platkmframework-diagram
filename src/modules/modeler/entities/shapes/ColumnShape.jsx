...
import { C_BASE_LINE, C_BASE_RECTANGLE, C_DEFAULT_BORDER_MOVE_COLOR, C_SUBTYPE_EDGES, C_ENTITY_SHAPE, C_COLUMN_SHAPE} from "../../constants/ShapeTypes"
...
export class ColumnShape extends RectangleShape{

    constructor(column){
        super();
        this.state = {...this.state}
        this.state.shape.type = C_COLUMN_SHAPE
    ...
    cloneElement(){
        let auxRectangleShape = new ColumnShape();
...
//---------------------FUNCIONES DE MOVIMIENTO IMPLEMENTADAS POR TODAS LAS FIGURAS----------------- */
    ...
    draw(ctx, selectedShapeData, shapeList){  
        ...
        ctx.beginPath();
        ctx.fillText(this.state.column.name, this.state.shape.x , this.state.shape.y  );
        ctx.stroke() 
        ctx.closePath()
